...
class Case(MyBaseApi):
    ...
    @aomaker.dependence("case_obj.get_directory", "directory_info", imp_module="apis.testcase.case")
    ...
    @aomaker.update("case_info")
    @aomaker.dependence("case_obj.get_testcases", "case_info", imp_module="apis.testcase.case")
